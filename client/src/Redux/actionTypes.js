...
//ui
export const SET_Account_Modal_Open = "SET_Account_Modal_Open";
export const SET_MatualAccount_Modal_Open = "SET_MatualAccount_Modal_Open";
export const SET_Profile_Modal_Open = "SET_Profile_Modal_Open";
export const SET_MENUBAR_ACCOUNT_Open = "SET_MENUBAR_ACCOUNT_Open";
export const SET_BG_SINGLE_ACCOUNT = "SET_BG_SINGLE_ACCOUNT";
